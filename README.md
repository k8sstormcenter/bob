...
- [Introduction](#software-bill-of-behaviour---tooling-bobctl)
- [Bill of Behavior (BoB) Overview](#bill-of-behavior-bob-overview)
  - [Vendor Example: ApplicationProfile CRD](#vendor-example-applicationprofile-crd)
  - [FAQ](#faq)
  - [Example Comparison: Seccomp vs BoB](#example-comparison-of-seccomp-with-bob-for-redis)
  ...
  - [BoB as a Transport and Enforcement Mechanism](#bob-as-a-transport-and-enforcement-mechanism)
  - [Origin Story](#origin-story)
  - [Understanding the Use Cases](#understanding-the-use-cases)
    - [Runtime Anomalies](#1-runtime-anomalies)
    - [Supply Chain Anomalies](#2-supply-chain-anomalies)
  - [Try it Out in a Live Lab](#try-it-out-in-a-live-lab)
  -  [Demo: Deploy an Application](#demo-deploy-a-application)
  - [Generate Traffic of Benign Behaviour](#generate-traffic-of-benign-behaviour)
  - [Create a Repeatable Positive Test](#create-a-repeatable-positive-test)
  - [Generate Runtime Attack](#generate-runtime-attack-normal-attack-that-abuses-cve)
  - [Generate Supply Chain Attack (WIP)](#generate-supply-chain-attack)
  - [License](#license-is-apache-20)
````

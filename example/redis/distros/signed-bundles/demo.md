...
`kubescape/values.yaml` pins `ghcr.io/k8sstormcenter/node-agent:v0.3.190` and `ghcr.io/k8sstormcenter/storage:v0.3.177`, built from the `signature-overlays` branch.
